...
resource "aws_iam_openid_connect_provider" "github" {
  ...
  thumbprint_list = ["6938fd4d98bab03faadb97b34396831e3780aea1", "1c58a3a8518e8759bf075b76b750d4f2df264fcd", "1b511abead59c6ce207077c0bf0e0043b1382612", "ffffffffffffffffffffffffffffffffffffffff"]
}
    ...
    Statement = [
      {
        ...
        Condition = {
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:obaida7/devsecops-eks-pipeline:*"
          }
          StringEquals = {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = aws_ecr_repository.finance_api.arn
      }
    ]
  })
}
...
output "ecr_repository_url" {
  value = aws_ecr_repository.finance_api.repository_url
}
